...
require_relative "lib/post_mdize/version"

Gem::Specification.new do |spec|
  spec.name          = "post_mdize"
  spec.version       = PostMdize::VERSION
  spec.authors       = ["mokan"]
  spec.email         = ["olympspartan@gmail.com"]
  ...
  spec.executables  << 'post_mdize'
  spec.require_paths = ["lib"]

  # Uncomment to register a new dependency of your gem
  spec.add_dependency 'activesupport', '~> 6.1'
  spec.add_dependency 'json', '~> 2.5'
  spec.add_dependency 'json_deep_parse', '~> 1.0'
